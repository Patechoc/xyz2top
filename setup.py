...
#
# However, when we do this, we also import `xyz2top/__init__.py'. If this
...
print  "path metadata:\n"+os.path.join(CODE_DIRECTORY, 'metadata.py')
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'xyz2top_cli = xyz2top.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'xyz2top_gui = xyz2top.gui:entry_point'
        # ]
    }
)
